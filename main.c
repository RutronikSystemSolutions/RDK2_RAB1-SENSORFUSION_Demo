...
int main(void)
{
    ...
    cyhal_gpio_enable_event(USER_BTN1, CYHAL_GPIO_IRQ_FALL, BUTTON_IRQ_PRIORITY, true);
    cyhal_gpio_enable_event(USER_BTN2, CYHAL_GPIO_IRQ_FALL, BUTTON_IRQ_PRIORITY, true);
